...
parser.add_argument('-c', '--config', default='configs/test.yaml', type=str, metavar='FILE',
...
parser.add_argument('--experiment', default='tort', type=str, metavar='NAME',
...
def main():
    ...
    if args.rank == 0:
        ...
        with open(join(output_dir, 'args.yaml'), 'w') as f:
            f.write(args_text)
    ...
    try:
        for epoch in range(start_epoch, num_epochs):
            ...
            if output_dir is not None:
                update_summary(
                    epoch, train_metrics, eval_metrics, join(output_dir, 'summary.csv'),
            ...
            if args.local_rank == 0:
                ...
                if args.save_images and output_dir:
                    torchvision.utils.save_image(
                        input,
                        join(output_dir, 'train-batch-%d.jpg' % batch_idx),
                        padding=0,
                        normalize=True)
