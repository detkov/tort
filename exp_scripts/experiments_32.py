...
if __name__ == '__main__':
    ...
    par_momentum_teacher = [0.995, 0.996, 0.997, 0.998, 0.999]

    configs = []
    for momentum_teacher in par_momentum_teacher:
        configs.append({'momentum_teacher': momentum_teacher, **common_params})
